package C01_evÖdevleri;

import java.util.Scanner;

public class task01_ödev1 {
    ...
    */
      ...
      // System.out.println("topumuzun sekme sayısı : " + sekme + " ve topun aldığı toplam mesafe :" + hareketMesafe);
        ...
        Scanner scan=new Scanner(System.in);
        System.out.println("topun bırakılacağı yükseklik:");
        double yükseklik=scan.nextInt();
        int sekme=0;
        double hareketMesafe=0;
        ...
        System.out.println("topun sekme sayısı:"+ sekme+"topun atıldığı toplam mesafe:"+hareketMesafe);
