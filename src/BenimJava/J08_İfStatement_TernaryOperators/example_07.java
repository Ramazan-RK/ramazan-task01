...
public class example_07 {
    public static void main(String[] args) {
      ...
      /*
          TASK ->Kullanıcının ehliyetinin varlığını kotrol ediniz.
          Ehliyeti varsa  yıl tecrübei 7 yıl ve üstü ise aldığı mesafe 100000 km ve üzeri ise kontak anahtarını veriniz
          aksi durumdaa tecrübe yılı ve mesafe eksiklerini print eden code create ediniz
        */
